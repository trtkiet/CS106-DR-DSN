...
def main():
    ...
    for epoch in range(start_epoch, args.max_epoch):
        ...
        for idx in idxs:
            ...
            for _ in range(args.num_episode):
                ...
                reward = compute_reward(seq, actions, use_gpu=use_gpu, ignore_far_sim=False)
    ...
    model_save_path = osp.join(args.save_dir, 'model_epoch' + str(args.max_epoch) + '-' + str(args.split_id) + '.pth.tar')
